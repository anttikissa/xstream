...
// invoked by calling the function stream(initial).
//
...
//
// Note that this will not go further than to the first ancestors.  In other
// words, if you say, for example,
//
...
// combinators, just .pull()in their value anyway
//
// Return this.
